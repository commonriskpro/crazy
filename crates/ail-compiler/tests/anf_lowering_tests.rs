...
// ── ola5-compiler-core: Gap 2 — CoreExpr → ANF lowering for 10 variants ──
//
// RED tests: confirm each of the 10 variants currently lowers to Placeholder.
// After implementation they must lower to real AnfExpr variants.
