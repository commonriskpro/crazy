...
//
// Covers all spec scenarios for the ten-command CLI (except package and remote):
//
...
//   G31 R2   — extended coverage of all commands above (no package/remote)
//   T7d      — LLM agent loop E2E
//
// Package tests live in package_cli.rs.
// Remote tests live in remote_cli.rs.
