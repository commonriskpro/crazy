...
#[test]
fn lsp_diagnose_accepts_return_markers_inside_source_match_arms() {
    use assert_fs::prelude::*;
    ...
    source
        .write_str(
            r#"
fn unwrap(value: Option<Int>) -> Int = match value {
  Some(v) => return v,
  None => return 0
}
...
#[test]
fn lsp_diagnose_accepts_braced_return_blocks_inside_source_match_arms() {
    use assert_fs::prelude::*;
...
#[test]
fn lsp_diagnose_accepts_multiline_source_match_arms_without_commas() {
    use assert_fs::prelude::*;
