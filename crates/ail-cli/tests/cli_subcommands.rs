...
fn run_file_executes_ail_source_int_bounds_helpers() {
    ...
    ail()
        ...
        .stdout(predicate::str::contains("result: 566"));
}
...
fn compile_file_rejects_source_int_bounds_helper_type_mismatch() {
    ...
    source
        .write_str("fn bounded(value: Int, fallback: Text) -> Int = int_bit_not(fallback)\n")
        .expect("source fixture must be written");
    ...
    ail()
        ...
        .failure()
        .stderr(predicate::str::contains(
            "type mismatch in int.bit_not argument 1: expected Int, got Text",
        ));
}
