...
pub(super) fn known_source_builtin_arity(call: &str) -> Option<SourceArity> {
    let arity = match call {
        ...
        "not" | "len" | "text.len" | "text.length" | "text_length" | "list.length"
        | "list_length" | "print" | "log.write" | "log_write" | "text.trim" | "text_trim"
        | "Var" | "is_empty" | "text.is_empty" | "text_is_empty" | "list.is_empty"
        | "list_is_empty" | "queue.pop_front" | "queue_pop_front" | "queue.peek_front"
        | "queue_peek_front" | "queue.length" | "queue_length" | "queue.is_empty"
        | "queue_is_empty" | "set.length" | "set_length" | "map.length" | "map_length"
        | "is_some" | "is_none" | "is_ok" | "is_err" | "option.is_some" | "option_is_some"
        | "option.is_none" | "option_is_none" | "result.is_ok" | "result_is_ok"
        | "result.is_err" | "result_is_err" | "tuple.length" | "tuple_length" | "tuple.first"
