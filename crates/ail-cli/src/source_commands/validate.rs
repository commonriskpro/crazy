...
pub(super) fn known_source_builtin_arity(call: &str) -> Option<SourceArity> {
    let arity = match call {
        ...
        "fs.write" | "fs_write" | "std.fs.write" | "env.set" | "env_set" | "std.env.set"
        | "field" | "index" | "list.get" | "list_get" | "list.push" | "list_push"
        | "list.concat" | "list_concat" | "queue.push_back" | "queue_push_back"
