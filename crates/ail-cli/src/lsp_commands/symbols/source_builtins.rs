...
pub(super) const AIL_SOURCE_BUILTIN_SYMBOLS: &[AclSymbol] = &[
    ...
    AclSymbol {
        label: "fs.read_file",
        detail: "AIL source FS helper",
        documentation: "Dotted alias that reads file contents as Bytes through file.read.",
        insert_text: "fs.read_file(${1:path})",
    },
    AclSymbol {
        label: "fs_write",
        detail: "AIL source FS helper",
    ...
    AclSymbol {
        label: "fs.list",
        detail: "AIL source FS helper",
        documentation: "Dotted alias that lists a Text directory path through file.list.",
        insert_text: "fs.list(${1:path})",
    },
    AclSymbol {
