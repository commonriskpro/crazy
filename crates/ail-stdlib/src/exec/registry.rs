...
use self::handlers::{
    ...
    option_map, option_ok_or, option_transpose, option_unwrap_or, path_from_text, path_to_text,
    queue_is_empty, queue_length, queue_peek_front, queue_pop_front, queue_push_back,
    result_and_then, result_map, result_transpose, result_unwrap_or, set_contains, set_insert,
    set_length, testing_assert_approx, testing_assert_eq, testing_expect_error,
