...
use self::handlers::{
    ...
    numeric_checked_sub, numeric_clamp, numeric_max, numeric_min, numeric_narrow_to_i32,
    numeric_narrow_to_u32, numeric_saturating_add, numeric_saturating_mul, numeric_saturating_neg,
    numeric_saturating_sub, numeric_wrapping_add, numeric_wrapping_mul, numeric_wrapping_neg,
