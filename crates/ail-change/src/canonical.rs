...
//
// `materialize_payload` and all its helper functions (verb/value extractors,
// workflow helpers, edge helpers, node constructors) live in a focused
// submodule to reduce god-file pressure on this file.
